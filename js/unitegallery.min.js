  ...
  function h() {
    ...
    for (i = 0; i < _; i++) {
      ...
      o - t + c > X.gridWidth &&
        ...
        (r = 0),
        d >= V.grid_num_rows
          ? ((d = 0), (t = o), (r = n), (l = 0), 1 == X.numPanes && ((X.gridWidth = a + V.grid_padding), G.width(X.gridWidth), (X.gridHeight = u + V.grid_padding), G.height(X.gridHeight)), X.numPanes++, X.arrPanes.push(t - V.grid_padding))
...
function UGTileDesign() {
  ...
  function n(e, t) {
    ...
    if (
      ...
      1 == B.tile_enable_border && ((o["border-width"] = B.tile_border_width + "px"), (o["border-style"] = "solid"), (o["border-color"] = B.tile_border_color), B.tile_border_radius && (o["border-radius"] = B.tile_border_radius + "px")),
  ...
  var B = {
    ...
    F = { thumb_color_overlay_effect: !0, thumb_overlay_reverse: !0, thumb_image_overlay_effect: !1, tile_textpanel_enable_description: !1, tile_textpanel_bg_opacity: 0.6, tile_textpanel_padding_top: 8, tile_textpanel_padding_bottom: 8 },
    Y = {
      ratioByHeight: 0,
      ratioByWidth: 0,
      eventSizeChange: "thumb_size_change",
...
function UGSlider() {
  ...
  function r(e) {
    ...
    if (
      ...
      (i += n(t, 3)),
      (i += "</div>"),
      1 == Se.slider_enable_arrows && ((i += "<div class='ug-slider-control ug-arrow-left ug-skin-" + Se.slider_arrows_skin + "'></div>"), (i += "<div class='ug-slider-control ug-arrow-right ug-skin-" + Se.slider_arrows_skin + "'></div>")),
...
function UGCarousel() {
  ...
  function j(e) {
    return 1 == V.touchActive
      ? !0
      : ((V.touchActive = !0), D.pauseAutoplay(), (V.startTime = jQuery.now()), (V.startMousePos = o(e)), (V.startInnerPos = r()), (V.lastTime = V.startTime), (V.lastMousePos = V.startMousePos), void B.storeEventData(e, V.storedEventID));
  }
  function C(e) {
    ...
    (c.style.cssText = "background-color:rgba(1,1,1,.5)"),
      ...
      (d.hsla.to = function (e) {
        ...
        var t,
          ...
          d = s + l,
          _ = 0.5 * d;
        return (t = l === s ? 0 : n === s ? (60 * (r - o)) / u + 360 : r === s ? (60 * (o - n)) / u + 120 : (60 * (n - r)) / u + 240), (i = 0 === u ? 0 : 0.5 >= _ ? u / d : u / (2 - d)), [Math.round(t) % 360, i, _, null == a ? 1 : a];
      }),
          ...
          h(o, function (t, i) {
            u.fn[t] ||
              (u.fn[t] = function (r) {
                ...
                return "undefined" === a
                  ? d
                  : ("function" === a && ((r = r.call(this, d)), (a = e.type(r))), null == r && i.empty ? this : ("string" === a && ((o = s.exec(r)), o && (r = d + parseFloat(o[2]) * ("+" === o[1] ? 1 : -1))), (u[i.idx] = r), this[l](u)));
              });
          });
      }),
      (u.hook = function (t) {
